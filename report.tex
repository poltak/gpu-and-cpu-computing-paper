...
idea of how CUDA attempts to facilitate heterogeneous computing can be seen in~\figref{fig:cuda-hetero}, which very much
reflects what was previously stated in~\sectref{sub:why_programs_aren_t_written_just_for_gpus_rather_than_cpus}.
